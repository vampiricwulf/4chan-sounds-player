...
/* provided dependency */ var _ = __webpack_require__(6325);
const selectors = __webpack_require__(218);
const hosts = __webpack_require__(5463);
...
/* provided dependency */ var Icons = __webpack_require__(4302);
module.exports = {
  '4chan': {
    postIdPrefix: 'p',
    posts: '.post',
...
/* provided dependency */ var _ = __webpack_require__(6325);
const { get } = __webpack_require__(6672);
...
module.exports = {
  template: __webpack_require__(7870),
  boardsTemplate: __webpack_require__(6844),
  listsTemplate: __webpack_require__(1675),
...
module.exports = {
  template: __webpack_require__(8210),
...
/* provided dependency */ var _ = __webpack_require__(6325);
const selectors = __webpack_require__(218);
const settingsConfig = __webpack_require__(5303);

const saveMenuTemplate = __webpack_require__(5080);

module.exports = {
  public: [ 'switch', 'next', 'previous' ],

  savedThemesTemplate: __webpack_require__(6305),
  themeKeybindsTemplate: __webpack_require__(3038),
...
module.exports = (data = {}) => `.dialog{background:var(--fcsp-background);background:var(--fcsp-background);border-color:var(--fcsp-border);border-radius:3px;box-shadow:0 1px 2px rgba(0,0,0,.15);border-radius:3px;padding-top:1px;padding-bottom:3px}.entry{position:relative;display:block;padding:.125rem .5rem;min-width:70px;white-space:nowrap}.entry.has-submenu::after{content:"";border-left:.5em solid;border-top:.3em solid transparent;border-bottom:.3em solid transparent;display:inline-block;margin:.35em;position:absolute;right:3px}.entry.focused{background:rgba(255,255,255,.33)}.entry.focused>.submenu{display:block}.submenu{position:absolute;display:none}`
...
/* provided dependency */ var _ = __webpack_require__(6325);
const { compileAction } = __webpack_require__(2887);
...
module.exports = {
    ...
    Player.on('rendered', function () {
      ...
      for (let eventList of audio) {
        for (let evt in eventList) {
          let handlers = Array.isArray(eventList[evt])
            ? eventList[evt]
            : [eventList[evt]];
          handlers.forEach((handler) =>
            Player.audio.addEventListener(evt, Player.getHandler(handler)),
          );
        }
      }
    });
  ...
  apply(element) {
    ...
    const eventAttrs = [];
    const elAttrs = document.evaluate(
      './/attribute::*[starts-with(name(), "@")]',
      element,
      null,
    ...
    const childAttrs = document.evaluate(
      './/*/attribute::*[starts-with(name(), "@")]',
      element,
      null,
      XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,
      ...
      const downListener = (e) => {
        ...
        if (!e._dragInit) {
          ...
          if (!e.preventDrag) {
            ...
            Player._mousedownMoveEl = mods.unbound
  ...
  off(evt, handler) {
    const index =
      Player.events._events[evt] && Player.events._events[evt].indexOf(handler);
    if (index > -1) {
  ...
  clearMousedown(e) {
    if (Player._mousedown) {
      ...
      Player._mousedown._eventListeners.pointdragend &&
        Player._mousedown._eventListeners.pointdragend(e);
...
/* provided dependency */ var _ = __webpack_require__(6325);
const colorpickerTemplate = __webpack_require__(9480);
...
/* provided dependency */ var _ = __webpack_require__(6325);
const buttons = __webpack_require__(5535);
...
module.exports = {
  ...
  arrowClockwise: (__webpack_require__(5226)/* ["default"] */ .A),
  arrowsCollapse: (__webpack_require__(1730)/* ["default"] */ .A),
  arrowDown: (__webpack_require__(4292)/* ["default"] */ .A),
  arrowsExpand: (__webpack_require__(5331)/* ["default"] */ .A),
  arrowRepeat: (__webpack_require__(8997)/* ["default"] */ .A),
  arrowUp: (__webpack_require__(991)/* ["default"] */ .A),
  boxArrowInLeft: (__webpack_require__(1733)/* ["default"] */ .A),
  boxArrowRight: (__webpack_require__(6818)/* ["default"] */ .A),
  chatRightQuote: (__webpack_require__(9908)/* ["default"] */ .A),
  checkSquare: (__webpack_require__(188)/* ["default"] */ .A),
  chevronDown: (__webpack_require__(6042)/* ["default"] */ .A),
  chevronUp: (__webpack_require__(2793)/* ["default"] */ .A),
  close: (__webpack_require__(2340)/* ["default"] */ .A).replace(/viewBox="[^"]+"/, 'viewBox="2 2 12 12"'),
  gear: (__webpack_require__(2181)/* ["default"] */ .A),
  fileEarmarkImage: (__webpack_require__(794)/* ["default"] */ .A),
  fileEarmarkMusic: (__webpack_require__(416)/* ["default"] */ .A),
  fileEarmarkPlay: (__webpack_require__(9101)/* ["default"] */ .A),
  filter: (__webpack_require__(706)/* ["default"] */ .A),
  fullscreen: (__webpack_require__(4855)/* ["default"] */ .A),
  fullscreenExit: (__webpack_require__(9520)/* ["default"] */ .A),
  github: (__webpack_require__(5737)/* ["default"] */ .A),
  image: (__webpack_require__(187)/* ["default"] */ .A),
  infoCircle: (__webpack_require__(2277)/* ["default"] */ .A),
  layoutTextWindow: (__webpack_require__(8979)/* ["default"] */ .A),
  link: (__webpack_require__(5916)/* ["default"] */ .A),
  musicNoteList: (__webpack_require__(5763)/* ["default"] */ .A),
  play: (__webpack_require__(1786)/* ["default"] */ .A).replace(/viewBox="[^"]+"/, 'viewBox="2 2 12 12"'),
  playFill: (__webpack_require__(5540)/* ["default"] */ .A).replace(/viewBox="[^"]+"/, 'viewBox="2 2 12 12"'),
  pause: (__webpack_require__(8250)/* ["default"] */ .A).replace(/viewBox="[^"]+"/, 'viewBox="2 2 12 12"'),
  pauseFill: (__webpack_require__(4708)/* ["default"] */ .A).replace(/viewBox="[^"]+"/, 'viewBox="2 2 12 12"'),
  plus: (__webpack_require__(6001)/* ["default"] */ .A),
  reboot: (__webpack_require__(3264)/* ["default"] */ .A),
  search: (__webpack_require__(8472)/* ["default"] */ .A),
  shuffle: (__webpack_require__(2487)/* ["default"] */ .A),
  skipEnd: (__webpack_require__(7453)/* ["default"] */ .A).replace(/viewBox="[^"]+"/, 'viewBox="2 2 12 12"'),
  skipEndFill: (__webpack_require__(137)/* ["default"] */ .A).replace(/viewBox="[^"]+"/, 'viewBox="2 2 12 12"'),
  skipStart: (__webpack_require__(1590)/* ["default"] */ .A).replace(/viewBox="[^"]+"/, 'viewBox="2 2 12 12"'),
  skipStartFill: (__webpack_require__(1992)/* ["default"] */ .A).replace(/viewBox="[^"]+"/, 'viewBox="2 2 12 12"'),
  soundwave: (__webpack_require__(8998)/* ["default"] */ .A),
  speaker: (__webpack_require__(7119)/* ["default"] */ .A),
  square: (__webpack_require__(6289)/* ["default"] */ .A),
  tools: (__webpack_require__(6933)/* ["default"] */ .A),
  trash: (__webpack_require__(2602)/* ["default"] */ .A),
  volumeMute: (__webpack_require__(7568)/* ["default"] */ .A).replace(/viewBox="[^"]+"/, 'viewBox="1 1 14 14"'),
  volumeMuteFill: (__webpack_require__(4250)/* ["default"] */ .A).replace(/viewBox="[^"]+"/, 'viewBox="1 1 14 14"'),
  volumeUp: (__webpack_require__(3220)/* ["default"] */ .A).replace(/viewBox="[^"]+"/, 'viewBox="1 1 14 14"'),
  volumeUpFill: (__webpack_require__(7654)/* ["default"] */ .A).replace(/viewBox="[^"]+"/, 'viewBox="1 1 14 14"')
};
...
module.exports = [
  {
    ...
    mix: true,
    default: __webpack_require__(1469)
  },
  {
...
const createTool = __webpack_require__(8433);
const downloadTool = __webpack_require__(6533);
const videoTool = __webpack_require__(7298);

module.exports = {
  template: __webpack_require__(2230),
...
/* provided dependency */ var Icons = __webpack_require__(4302);
/* provided dependency */ var _ = __webpack_require__(6325);
const { postIdPrefix } = __webpack_require__(218);
...
/* provided dependency */ var _ = __webpack_require__(6325);
const settingsConfig = __webpack_require__(5303);
const migrations = __webpack_require__(851);

const hosts = __webpack_require__(780);
...
module.exports = {
  ...
  settingTemplate: __webpack_require__(1555),
  inputTemplates: {
    checkbox: __webpack_require__(1470),
    input: __webpack_require__(1691),
    select: __webpack_require__(9045),
    textarea: __webpack_require__(8475)
  },
...
/* provided dependency */ var _ = __webpack_require__(6325);
const selectors = __webpack_require__(218);
const controlsTemplate = __webpack_require__(3980);
...
/* provided dependency */ var _ = __webpack_require__(6325);
const progressBarsTemplate = __webpack_require__(5563);
const videoUtil = __webpack_require__(439);
...
const downloadTool = module.exports = {
  downloadTemplate: __webpack_require__(4805),
  _downloading: null,
...
/* provided dependency */ var _ = __webpack_require__(6325);
const cssTemplate = __webpack_require__(42);
const cssVarsTemplate = __webpack_require__(9449);
const css4chanXPolyfillTemplate = __webpack_require__(2674);

const menus = {
  themes: __webpack_require__(3272),
  views: __webpack_require__(928)
};
...
/* provided dependency */ var _ = __webpack_require__(6325);
const cfg = __webpack_require__(8551);
const util = __webpack_require__(439);
...
const completeTemplate = __webpack_require__(4859);
const hostsTemplate = __webpack_require__(9103);
...
const createTool = module.exports = {
  _uploadIdx: 0,
  createTemplate: __webpack_require__(5257),
...
/* provided dependency */ var Icons = __webpack_require__(4302);
const { postIdPrefix } = __webpack_require__(218);
const xhrReplacer = __webpack_require__(3571);

const itemMenuTemplate = __webpack_require__(2663);
...
module.exports = {
  ...
  template: __webpack_require__(4837),
  listTemplate: __webpack_require__(4486),
  tagsDialogTemplate: __webpack_require__(8808),
  ...
  initialize() {
    ...
    Player.on('playsound', (sound) => {
      ...
      Player.$all(
        `.${ns}-list-item.playing, .${ns}-list-item[data-id="${Player.playing.id}"]`,
      ).forEach((el) => {
  ...
  afterRender() {
    ...
    Player.playlist.transparentImageBG = Player.$(
   ...
   */
  resizeTransBG() {
    const contentBoxRatio =
      Player.playlist.image.width / Player.playlist.image.height;
  ...
  addFromFiles(files) {
    ...
    [...files].forEach((file) => {
      ...
      function _continue() {
        const { sounds } = Player.posts.getSounds(
          file.name,
          imageSrc,
          null,
          thumbSrc,
  ...
  handleItemMenu(e, id) {
    ...
    const relative = e.currentTarget.classList.contains(
      `${ns}-item-menu-button`,
    )
      ? e.currentTarget
      : e;
  ...
  loadTags(id) {
    ...
    Player.playlist.tagLoadTO[id] = setTimeout(() => {
      ...
      reader._findFileReader().prototype._createXHRObject = () =>
        new xhrReplacer.GM();
...
const components = {
  ...
  settings: __webpack_require__(6279),
  events: __webpack_require__(3319),
  actions: __webpack_require__(2189),
  colorpicker: __webpack_require__(3378),
  controls: __webpack_require__(9912),
  display: __webpack_require__(6764),
  footer: __webpack_require__(337),
  header: __webpack_require__(8563),
  hotkeys: __webpack_require__(9433),
  inline: __webpack_require__(6431),
  minimised: __webpack_require__(3613),
  playlist: __webpack_require__(9200),
  position: __webpack_require__(2473),
  posts: __webpack_require__(1),
  theme: __webpack_require__(2475),
  threads: __webpack_require__(591),
  tools: __webpack_require__(5305),
  userTemplate: __webpack_require__(3722),
};
...
module.exports = (data = {}) => `:root{--fcsp-text: ${Player.config.colors.text};--fcsp-background: ${Player.config.colors.background};--fcsp-border: ${Player.config.colors.border};--fcsp-odd-row: ${Player.config.colors.odd_row};--fcsp-even-row: ${Player.config.colors.even_row};--fcsp-playing: ${Player.config.colors.playing};--fcsp-dragging: ${Player.config.colors.dragging};--fcsp-controls-background: ${Player.config.colors.controls_background};--fcsp-controls-active: ${Player.config.colors.controls_active};--fcsp-controls-inactive: ${Player.config.colors.controls_inactive};--fcsp-controls-empty-bar: ${Player.config.colors.controls_empty_bar};--fcsp-controls-loaded-bar: ${Player.config.colors.controls_loaded_bar};--fcsp-muted: #909090;--fcsp-max-pip-size: ${Player.config.maxPIPWidth}}`
...
/* provided dependency */ var _ = __webpack_require__(6325);
module.exports = {
  template: __webpack_require__(3980),
